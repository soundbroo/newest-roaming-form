...
export const MESSAGES = {
  ...
  extendedFormNumbers:
    "Превышено число абонентов, предельно допустимое количество для одной заявки - 99"
};
...
export const HELPER_TEXT = {
  astralId:
    "Идентификатор пользователя в системе ЭДО Калуга Астрал. Префикс оператора дописывать не нужно.",
  operatorId:
    "Идентификатор пользователя в системе ЭДО оператора. Префикс оператора дописывать не нужно.",
  email:
